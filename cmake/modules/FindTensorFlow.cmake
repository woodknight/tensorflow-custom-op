...
macro(add_tensorflow_cpu_operation_bk op_name)
...
macro(add_hdrnet_operation3)
# Compiles a CPU + GPU operation with invoking NVCC
  message(STATUS "will build custom TensorFlow operation")
  ...
  if(EXISTS "kernels/${op_name}_kernel.cu")
    ...
    set_source_files_properties(bilateral_slice.cu.cc PROPERTIES CUDA_SOURCE_PROPERTY_FORMAT OBJ)
     set(kernel_file bilateral_slice.cu.cc)
  endif()

  cuda_add_library(hdrnet_op_cu ${kernel_file})
  set_target_properties(hdrnet_op_cu PROPERTIES PREFIX "")

  add_library(hdrnet_op SHARED bilateral_slice.cc)

  set_target_properties(hdrnet_op PROPERTIES PREFIX "")
  set_target_properties(hdrnet_op PROPERTIES COMPILE_FLAGS "-DGOOGLE_CUDA")
  target_link_libraries(hdrnet_op LINK_PUBLIC hdrnet_op_cu ${TensorFlow_LIBRARY})
endmacro()
